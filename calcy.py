...
class Calculator:
    ...
    def button_press(self, value):
        ...
        if value == 'AC':
            entry_val = '' 
            self.symbol_pressed_trigger = False 
        elif self.symbol_pressed_trigger:
            entry_val = value
            self.symbol_pressed_trigger = False 
        else:
            ...
            # concat new number with an old number
    ...
    def math_button_press(self, value):
        ...
        if self.isfloat(str(self.number_entry.get())):
            ...
            #set symbol_pressed_trigger to True as one of the symbols is pressed
            self.symbol_pressed_trigger = True
            # Clear the entry box
            self.number_entry.delete(0, "end")
